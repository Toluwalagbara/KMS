...
public class ChartDemoView implements Serializable {
    ...
    private void createPieModel() {
        ...
        bgColors.add("rgb(65, 149, 68)");
        bgColors.add("rgb(25, 105, 174)");
        bgColors.add("rgb(251, 192, 45)");
...
//        dataSet.setLabel("Farmers progression by year");
        dataSet.setBorderColor("rgb(65, 149, 68)");
        dataSet.setTension(0.1);
        data.addChartDataSet(dataSet);

        List<String> labels = new ArrayList<>();
        labels.add("Fy 22(Jul - Dec 21)");
        labels.add("Fy 22(Jan - Jun 22)");
        labels.add("Fy 23(Jul 22 - Dec 22)");
        labels.add("Fy 23(Jan 23 - Jun 23)");
        labels.add("Fy 24(July 23 - Dec 23)");
//        labels.add("June");
//        labels.add("July");
        data.setLabels(labels);
...
//        title.setDisplay(true);
        title.setText("Farmers progression by year");
...
//        barDataSet.setLabel("Farmers by state");
...
//        values.add(55);
        ...
        bgColor.add("rgba(65, 149, 68, 0.2)");
        bgColor.add("rgba(251, 192, 45, 0.2)");
        bgColor.add("rgba(65, 149, 68, 0.2)");
        bgColor.add("rgba(251, 192, 45, 0.2)");
        bgColor.add("rgba(65, 149, 68, 0.2)");
        bgColor.add("rgba(25, 105, 174, 0.2)");
        bgColor.add("rgba(25, 105, 174, 0.2)");
        barDataSet.setBackgroundColor(bgColor);

        List<String> borderColor = new ArrayList<>();
        borderColor.add("rgb(251, 192, 45)");
        borderColor.add("rgb(65, 149, 68)");
        borderColor.add("rgb(251, 192, 45)");
        borderColor.add("rgb(65, 149, 68)");
        borderColor.add("rgb(25, 105, 174)");
